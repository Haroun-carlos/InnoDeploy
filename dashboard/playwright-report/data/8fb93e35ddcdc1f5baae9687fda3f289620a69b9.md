...
- Name: projects-pipeline.spec.ts >> shows a seeded project in projects list
- Location: tests\e2e\projects-pipeline.spec.ts:4:5
        ...
        - generic [ref=e35]:
          - generic [ref=e36]:
            ...
            - textbox "Email" [ref=e37]:
              ...
              - text: e2e-1775012395844-cicwrh@example.com
          - generic [ref=e38]:
            - text: Password

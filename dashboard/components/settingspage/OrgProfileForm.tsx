...
export default function OrgProfileForm({ value, onChange, onSubmit, saving, disabled }: OrgProfileFormProps) {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-xl">Organisation Profile</CardTitle>
        <CardDescription>Update your workspace identity, slug, and billing contact details.</CardDescription>
      </CardHeader>

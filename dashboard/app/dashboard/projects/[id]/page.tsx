  ...
  useEffect(() => {
    ...
    const loadProjectData = async () => {
      try {
        ...
        setRepositoryPath(projectData.repositoryPath || '');
          ...
          {activeTab === "Settings" && (
            <div className="space-y-6">
              ...
              <div className="rounded-lg border bg-card p-5 space-y-4">
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-medium">Repository Subdirectory</label>
                  <input
                    type="text"
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Optional. Leave blank to use the repository root.
                  </p>
                </div>
